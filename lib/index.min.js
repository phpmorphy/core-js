    ...
    var AbstractTransactionBase = /** @class */ (function (_super) {
        ...
        Object.defineProperty(AbstractTransactionBase.prototype, "value", {
            ...
            set: function (value) {
                ...
                var b = this._numberToBytes(value);
                for (var i = 0; i < 8; i++) {
        ...
        AbstractTransactionBase.prototype._numberToBytes = function (value) {
            var l = 1;
        ...
        AbstractTransactionBase.prototype._bytesToNumber = function (bytes) {
            if (((this._bytes[69] << 8) + this._bytes[70]) > 0x001f) {
                throw new Error('value is not safe integer');
            }
            var h = (this._bytes[69] << 24) + (this._bytes[70] << 16) + (this._bytes[71] << 8) + this._bytes[72];
            var l = (this._bytes[73] << 24) + (this._bytes[74] << 16) + (this._bytes[75] << 8) + this._bytes[76];
        ...
        Object.defineProperty(AbstractTransactionBase.prototype, "nonce", {
            ...
            set: function (nonce) {
                ...
                var b = this._numberToBytes(nonce);
                for (var i = 0; i < 8; i++) {
        ...
        AbstractTransactionBase.prototype.sign = function (secretKey) {
            ...
            // unsigned begin = 0
            // unsigned end = 85
            var msg = this._bytes.slice(0, 85);
